    ...
    render() {
        return (
            <Fragment>
                ...
                >
                    <View className='head'>
                        <Text className='head-title'>日程</Text>
                        <Image
                    ...
                    <AtTabs
                        ...
                        //     // {title: '资源'},
                        // ]}
                        tabList={this.props.tab_info.titles.map((item, index) => {
                            return {
                                title: process.env.TARO_ENV === "weapp" ? <View key={item.title + index}>
                                    {item.title}
                                    <View>
                                        {"周" + "日一二三四五六".charAt(item.time.getDay())}
                                    </View>
                                </View> : item.title,
