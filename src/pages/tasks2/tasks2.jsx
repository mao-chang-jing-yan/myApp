        ...
        <View className='cnt'>
          ...
          <View className='date-line'>
              <View className='day-box'>
                  <Text className='week'>周一</Text>
                  <Text className='day'>09/01</Text>
              </View>
              <View className='day-box'>
                  <Text className='week'>周一</Text>
                  <Text className='day'>09/01</Text>
        ...
        <View className='cnt3'>
          ...
          <View className='tasks'>
              <View className='task-item-box'>
                  ...
                  <View className='time'>
                      <View className='time-clock'>8:00</View>
                      <View className='time-apm'>A M</View>
                  </View>
                  <View className='task-info-box'>
                      <Text className='name'>课程名称</Text>
