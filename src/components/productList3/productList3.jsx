                            ...
                            >
                                <View className="flex-col group_9">
                                    <Image className="image_8" mode="aspectFill"
                                           src={item.img_url ? item.img_url : imgurl} />
                                    <Text className="text_14 text_15 name"
                                          decode="decode">{item.name ? item.name : "椅子"}</Text>
                                </View>
                                <View className="justify-between group_10">
                                    <View className="left-group">
                                        <Text className="text_16" decode="decode">￥</Text>
                                        <Text className="text_18" decode="decode">{item.price ? item.price : 300}</Text>
                                    </View>
