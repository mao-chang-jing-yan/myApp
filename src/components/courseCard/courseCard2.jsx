...
import "./courseCard2.scss"
import Taro from "@tarojs/taro";
import image from "@assets/imgs/1234.png"
...
const CourseCard2 = (props) => {
    ...
    courseInfo.imageUrl = courseInfo.imageUrl ? courseInfo.imageUrl : image;

    return (
        <Fragment>
            <View className='CourseCard1-item'
                  style={{height: height, width: width, backgroundColor: selected?"":"rgb(245,98,67, 0.1)", color: selected?"":"black"}}
